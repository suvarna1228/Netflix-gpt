...
const Login = () => {
  ...
  <div >
    ...
    <form onSubmit={(e)=>e.preventDefault()} className="max-w-md w-full sm:w-8/12 md:w-6/12 lg:w-3/12 absolute p-14 bg-black bg-opacity-80 my-20 mx-auto text-white right-0 left-0 rounded-lg shadow-lg">
